...
function App() {
  return (
    <Container>
          ...
          <Grid.Row>
            <Grid.Column>
              <Statistic size='tiny' color='green'>
                <Statistic.Label style={{texAlign:'left'}}>Income:</Statistic.Label>
                <Statistic.Value>1,045.50</Statistic.Value>
              </Statistic>
            </Grid.Column>
            <Grid.Column>
            <Statistic size='tiny' color='red'>
                <Statistic.Label style={{texAlign:'left'}}>Expenses:</Statistic.Label>
      ...
      <Form unstackable>
        <Form.Group>
          <Form.Input placeholder='New shiny thing' icon='tags' width={12} label='Description'/>
